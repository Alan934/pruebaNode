...
const BannerServices2: React.FC<HeroBannerProps> = ({ Fondo, title , listBanner}) => {
    return (
      <div className="relative flex items-center justify-start w-full h-auto py-8">
        ...
        />
          <div className="z-10 mx-9 movil:mx-10 tablet:mx-48">
            <h2 className="text-[#543799] font-normal text-xl mb-5">{title}</h2>
            <div>
  ...
  export default BannerServices2;
